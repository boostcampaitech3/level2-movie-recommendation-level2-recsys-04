...
parser.add_argument('--early_stopping_epochs', type=int, default=10, metavar='ES',
                    help='number of epochs for early stopping')

parser.add_argument('--warmup', type=int, default=0, metavar='WU',
                    help='number of epochs for warm-up')
parser.add_argument('--max_beta', type=float, default=0.3, metavar='B',
...
parser.add_argument('--z1_size', type=int, default=500, metavar='M1',
                    help='latent size')
parser.add_argument('--z2_size', type=int, default=500, metavar='M2',
                    help='latent size')
parser.add_argument('--hidden_size', type=int, default=1000 , metavar="H",
...
parser.add_argument('--inference', type=str, default=False,
                    help='inference if True else train')
...
def run(args, kwargs):
    ...
    # loading data
    train_loader, args = load_dataset(args, **kwargs)
    ...
    experiment_vae(args, train_loader, model, optimizer, dir, log_dir, model_name = args.model_name)
    # ======================================================================================================================
