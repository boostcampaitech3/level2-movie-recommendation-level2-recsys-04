...
def load_ml20m(args, **kwargs):
    ...
    unique_sid = list()
    with open('/opt/ml/input/data/train/pro_sg/unique_sid.txt', 'r') as f:
        for line in f:
    ...
    x_train = load_train_data('/opt/ml/input/data/train/pro_sg/train.csv')
    np.random.shuffle(x_train)
    # x_val_tr, x_val_te = load_tr_te_data('/opt/ml/input/data/train/pro_sg/validation_tr.csv',
    #                                      '/opt/ml/input/data/train/pro_sg/validation_te.csv')

    # x_test_tr, x_test_te = load_tr_te_data('/opt/ml/input/data/train/pro_sg/test_tr.csv',
    #                                        '/opt/ml/input/data/train/pro_sg/test_te.csv')
...
def load_dataset(args, **kwargs):
    if args.dataset_name == 'ml20m':
        ...
        train_loader, args = load_ml20m(args, **kwargs)
